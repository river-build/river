...
import { ELogger, elogger, shortenHexString } from '@river-build/dlog'
...
import { MlsEncryptedContentItem, StreamUpdateDelegate, StreamUpdate } from './types'
...
export class MlsStream implements StreamUpdateDelegate {
    ...
    private _onChainView = new RemoteView()
    ...
    public async handleStreamUpdate(streamUpdate: StreamUpdate): Promise<void> {
        ...
        this._onChainView = await RemoteView.loadFromStreamStateView(view, { log: this.log })
