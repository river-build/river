...
import { IArchitectBase, ISpaceDapp, PricingModuleStruct } from '@river-build/web3';
...
export declare function createSpaceAndDefaultChannel(client: Client, spaceDapp: ISpaceDapp, wallet: ethers.Wallet, name: string, membership: IArchitectBase.MembershipStruct): Promise<{
    spaceId: string;
    defaultChannelId: string;
    userStreamView: StreamStateView;
}>;
export declare function createUserStreamAndSyncClient(client: Client, spaceDapp: ISpaceDapp, name: string, membershipInfo: IArchitectBase.MembershipStruct, wallet: ethers.Wallet): Promise<void>;
