...
import { AddEventResponse_Error, EncryptedData, UserInboxPayload_GroupEncryptionSessions } from '@river-build/proto';
...
export declare class ClientDecryptionExtensions extends BaseDecryptionExtensions {
    ...
    sendKeyFulfillment({ streamId, userAddress, deviceKey, sessionIds, }: KeyFulfilmentData): Promise<{
