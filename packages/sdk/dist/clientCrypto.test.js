...
describe('clientCrypto', () => {
    ...
    test('clientCanEncryptDecryptEvent', async () => {
        ...
        expect(alicesClient.encryptionDevice.deviceCurve25519Key !==
            bobsClient.encryptionDevice.deviceCurve25519Key).toBe(true);
        ...
        const clear = await bobsClient.cryptoBackend?.decryptWithDeviceKey(envelope[bobsClient.userDeviceKey().deviceKey], alicesClient.userDeviceKey().deviceKey);
        log('clear', clear);
