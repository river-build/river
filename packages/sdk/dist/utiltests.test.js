...
function stripAnsiColors(input) {
...
describe('util.test', () => {
    ...
    test('waitFor fails', async () => {
        ...
        try {
            ...
            expect(errorMsg).toContain('Error: expect(received).toEqual(expected) // deep equality\n\nExpected: 4\nReceived: 0');
        }
        expect(r).toBeUndefined();
    });
    test('hashString', () => {
        expect(hashString('hello')).toEqual('1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8');
        expect(hashString('another string')).toEqual('190b6b638e653f426b7e144f1db5ede7bdb1668e28f7ee0352f20f0678f29e09');
    });
});
//# sourceMappingURL=utiltests.test.js.map