...
export declare const make_SpacePayload_ChannelUpdate: (value: PlainMessage<SpacePayload_ChannelUpdate>) => PlainMessage<StreamEvent>['payload'];
...
export declare const getChannelUpdatePayload: (event: ParsedEvent | StreamEvent | undefined) => SpacePayload_ChannelUpdate | undefined;
