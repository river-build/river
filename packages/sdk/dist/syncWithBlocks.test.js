...
import { getMessagePayload, getMiniblockHeader, make_ChannelPayload_Inception, make_ChannelPayload_Message, make_MemberPayload_Membership2, make_SpacePayload_Inception, make_UserPayload_Inception, } from './types';
import { TEST_ENCRYPTED_MESSAGE_PROPS, makeRandomUserContext, makeTestRpcClient, makeUniqueSpaceStreamId, iterableWrapper, } from './util.test';
...
describe('syncWithBlocks', () => {
    ...
    test('blocksGetGeneratedAndSynced', async () => {
        ...
        const events = (await unpackStream(channel.stream)).streamAndCookie.miniblocks.flatMap((mb) => mb.events);
...
//# sourceMappingURL=syncWithBlocks.test.js.map