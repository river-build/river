import { SnapshotCaseType, FullyReadMarker, UserInboxPayload_GroupEncryptionSessions, UserSettingsPayload_UserBlock } from '@river-build/proto';
import { ClientInitStatus, ConfirmedTimelineEvent, DecryptedTimelineEvent, LocalTimelineEvent, RemoteTimelineEvent, StreamTimelineEvent } from './types';
...
export type StreamEncryptionEvents = {
    ...
    newKeySolicitation: (streamId: string, fromUserId: string, fromUserAddress: Uint8Array, event: KeySolicitationContent) => void;
    updatedKeySolicitation: (streamId: string, fromUserId: string, fromUserAddress: Uint8Array, event: KeySolicitationContent) => void;
...
export type StreamStateEvents = {
    ...
    eventDecrypted: (streamId: string, contentKind: SnapshotCaseType, event: DecryptedTimelineEvent) => void;
