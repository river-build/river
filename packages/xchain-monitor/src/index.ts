...
import { createPublicClient, PublicClient, http, HttpTransport, Address, Hex } from 'viem'
import { config } from './environment'
import { getLogger } from './logger'

const logger = getLogger('xchain-monitor')
...
async function scanBlockchainEvents(
...
async function main() {  
  const results = await scanBlockchainEvents(
