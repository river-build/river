...
export class ChunkedMedia extends Message<ChunkedMedia> {
  ...
  encryption: {
    ...
    /**
     * @generated from field: river.ChunkedMedia.DerivedAESGCM derived = 102;
     */
    value: ChunkedMedia_DerivedAESGCM;
    case: "derived";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 102, name: "derived", kind: "message", T: ChunkedMedia_DerivedAESGCM, oneof: "encryption" },
  ]);
...
export class ChunkedMedia_DerivedAESGCM extends Message<ChunkedMedia_DerivedAESGCM> {
  /**
   * @generated from field: string seed_phrase = 1;
   */
  seedPhrase = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "seed_phrase", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChunkedMedia_DerivedAESGCM {
    return new ChunkedMedia_DerivedAESGCM().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChunkedMedia_DerivedAESGCM {
    return new ChunkedMedia_DerivedAESGCM().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChunkedMedia_DerivedAESGCM {
    return new ChunkedMedia_DerivedAESGCM().fromJsonString(jsonString, options);
  }

  static equals(a: ChunkedMedia_DerivedAESGCM | PlainMessage<ChunkedMedia_DerivedAESGCM> | undefined, b: ChunkedMedia_DerivedAESGCM | PlainMessage<ChunkedMedia_DerivedAESGCM> | undefined): boolean {
    return proto3.util.equals(ChunkedMedia_DerivedAESGCM, a, b);
  }
}
