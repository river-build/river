...
const CACHE_CONTROL = {
	200: 'public, max-age=30, s-maxage=3600, stale-while-revalidate',
	307: 'public, max-age=30, s-max-age=3600m, stale-while-revalidate', // NOTE: this is called when the space uses a different image service than ours, but a client is requesting the image from our service.
