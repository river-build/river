...
description: The following guide describes steps and best practices for configuring a River Stream Node after meeting the [system requirements](/run/node-operator/system-requirements-installation).
---
...
<Steps>
  <Step title="Generate configuration associated with the Node Storage">
    ...
    database schema and to authenticate the Node FE to the River Chain during registration.
