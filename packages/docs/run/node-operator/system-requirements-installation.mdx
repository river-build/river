...
The Towns Lodge maintains a public docker image registry `public.ecr.aws/h5v6m2x1/river` for images that are built officially from [source](https://github.com/river-build/river) during CI/CD.
