---
title: Adding Events to Towns Stream
description: ""
---

### Adding events to a Towns Stream

Events can be added to a Towns Stream Node over rpc using the service interface exposed by the protocol in `protocol.proto`. The following guide will illustrate a concrete example of making an `addEvent` request.
