...
River smart contracts are deployed using the Diamond Pattern (see [EIP-2525](https://eips.ethereum.org/EIPS/eip-2535)), which improves upon modularity and upgradeability.
