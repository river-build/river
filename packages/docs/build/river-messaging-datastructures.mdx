...
The data schema of the River protocol can be defined declaratively by [protobuf.proto](https://github.com/HereNotThere/harmony/blob/main/casablanca/proto/protocol.proto). Below is an elided snapshot of `protocol.proto` as of January 2024 containing only schema definitions used in a messaging context within the River protocol.
