...
The data schema of the Towns protocol can be defined declaratively by [protobuf.proto](https://github.com/river-build/river/blob/main/protocol/protocol.proto). Below is an elided snapshot of `protocol.proto` as of January 2024 containing only schema definitions used in a messaging context within the Towns protocol.
