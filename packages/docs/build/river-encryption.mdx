---
title: River Encryption Protocol
description: "How the River encryption and decryption protocol works."
---

### What is the River Encryption Protocol?

The River protocol supports end-to-end encryption and decryption between
...
### Core entities in the River Encryption Protocol
...
The River Encryption Protocol uses this libray to create a group session, and
...
See [river-tutorials/encryption-import](https://github.com/river-build/river-tutorials/tree/main/encryption-import) for a tutorial on how to import the River Encryption
npm package.
...
> The River Encryption Protocol is designed to support new algorithms. There is
