import { BasicRoleInfo, ChannelDetails, ChannelMetadata, MembershipInfo, MembershipStruct, Permission, PricingModuleStruct, RoleDetails, TotalSupplyInfo } from './ContractTypes';
...
export interface ISpaceDapp {
    ...
    createChannel: (spaceId: string, channelName: string, channelNetworkId: string, roleIds: number[], signer: SignerType, txnOpts?: TransactionOpts) => Promise<TransactionType>;
    createRole(spaceId: string, roleName: string, permissions: Permission[], users: string[], ruleData: IRuleEntitlement.RuleDataStruct, signer: SignerType, txnOpts?: TransactionOpts): Promise<TransactionType>;
    ...
    isEntitledToChannel: (spaceId: string, channelId: string, user: string, permission: Permission) => Promise<boolean>;
    getEntitledWalletForJoiningSpace: (spaceId: string, wallet: string, supportedXChainRpcUrls: string[]) => Promise<string | undefined>;
    ...
    updateSpaceName: (spaceId: string, name: string, signer: SignerType, txnOpts?: TransactionOpts) => Promise<TransactionType>;
