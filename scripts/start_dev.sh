...
commands=(
    ...
    "river_stream_metadata_multi:./scripts/start-stream-metadata-service.sh"
    "river_stream_metadata_multi_ne:./scripts/start-stream-metadata-service.sh -e local_multi_ne"
)
