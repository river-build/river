...
import {IEntitlementDataQueryableV2, IEntitlementDataQueryableBaseV2} from "contracts/src/spaces/facets/entitlements/extensions/IEntitlementDataQueryableV2.sol";
...
contract EntitlementDataQueryableTest is
  BaseSetup,
  IEntitlementDataQueryableBaseV2,
  IRolesBase
{
  IEntitlementDataQueryableV2 internal entitlements;
  MockUserEntitlement internal mockEntitlement;

  function setUp() public override {
    super.setUp();

    entitlements = IEntitlementDataQueryableV2(everyoneSpace);
  ...
  function test_getEntitlementDataByRole_Legacy() external {
    IEntitlementDataQueryableBase.EntitlementData[]
      memory entitlement = entitlements.getEntitlementDataByPermission(
  ...
  function test_getEntitlementDataByRole() external {
    EntitlementData[] memory entitlement = entitlements
      .getEntitlementDataByPermissionV2(Permissions.JoinSpace);
  ...
  function test_GetChannelEntitlementDataByPermission_Legacy() external {
  ...
  function test_GetChannelEntitlementDataByPermission() external {
    ...
    EntitlementData[] memory channelEntitlements = entitlements
      .getChannelEntitlementDataByPermissionV2(channelId, Permissions.Read);
