...
We use changeset to manage versions and upload to npm
[changeset cli](https://github.com/changesets/changesets/blob/main/packages/cli/README.md)
[turbo documentation](https://turbo.build/repo/docs/guides/publishing-libraries#versioning-and-publishing)