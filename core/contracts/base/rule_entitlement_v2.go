...
// IRuleEntitlementV2CheckOperation is an auto generated low-level Go binding around an user-defined struct.
type IRuleEntitlementV2CheckOperation struct {
	OpType          uint8
	ChainId         *big.Int
	ContractAddress common.Address
	Params          []byte
...
// IRuleEntitlementV2LogicalOperation is an auto generated low-level Go binding around an user-defined struct.
type IRuleEntitlementV2LogicalOperation struct {
	LogOpType           uint8
	LeftOperationIndex  uint8
	RightOperationIndex uint8
}

// IRuleEntitlementV2Operation is an auto generated low-level Go binding around an user-defined struct.
type IRuleEntitlementV2Operation struct {
	OpType uint8
	Index  uint8
}

// IRuleEntitlementV2RuleData is an auto generated low-level Go binding around an user-defined struct.
type IRuleEntitlementV2RuleData struct {
	Operations        []IRuleEntitlementV2Operation
	CheckOperations   []IRuleEntitlementV2CheckOperation
	LogicalOperations []IRuleEntitlementV2LogicalOperation
}
...
func (_RuleEntitlementV2 *RuleEntitlementV2Caller) EncodeRuleData(opts *bind.CallOpts, data IRuleEntitlementRuleData) ([]byte, error) {
	var out []interface{}
...
//
// Solidity: function encodeRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlementV2 *RuleEntitlementV2Session) EncodeRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
...
//
// Solidity: function encodeRuleData(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlementV2 *RuleEntitlementV2CallerSession) EncodeRuleData(data IRuleEntitlementRuleData) ([]byte, error) {
	return _RuleEntitlementV2.Contract.EncodeRuleData(&_RuleEntitlementV2.CallOpts, data)
}

// EncodeRuleDataV2 is a free data retrieval call binding the contract method 0x06bd0e1e.
//
// Solidity: function encodeRuleDataV2(((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlementV2 *RuleEntitlementV2Caller) EncodeRuleDataV2(opts *bind.CallOpts, data IRuleEntitlementV2RuleData) ([]byte, error) {
	var out []interface{}
	err := _RuleEntitlementV2.contract.Call(opts, &out, "encodeRuleDataV2", data)
...
//
// Solidity: function encodeRuleDataV2(((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlementV2 *RuleEntitlementV2Session) EncodeRuleDataV2(data IRuleEntitlementV2RuleData) ([]byte, error) {
	return _RuleEntitlementV2.Contract.EncodeRuleDataV2(&_RuleEntitlementV2.CallOpts, data)
}

// EncodeRuleDataV2 is a free data retrieval call binding the contract method 0x06bd0e1e.
//
// Solidity: function encodeRuleDataV2(((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[]) data) pure returns(bytes)
func (_RuleEntitlementV2 *RuleEntitlementV2CallerSession) EncodeRuleDataV2(data IRuleEntitlementV2RuleData) ([]byte, error) {
	return _RuleEntitlementV2.Contract.EncodeRuleDataV2(&_RuleEntitlementV2.CallOpts, data)
}
...
func (_RuleEntitlementV2 *RuleEntitlementV2Caller) GetRuleData(opts *bind.CallOpts, roleId *big.Int) (IRuleEntitlementRuleData, error) {
	var out []interface{}
	err := _RuleEntitlementV2.contract.Call(opts, &out, "getRuleData", roleId)
...
//
// Solidity: function getRuleData(uint256 roleId) view returns(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data)
func (_RuleEntitlementV2 *RuleEntitlementV2Session) GetRuleData(roleId *big.Int) (IRuleEntitlementRuleData, error) {
	return _RuleEntitlementV2.Contract.GetRuleData(&_RuleEntitlementV2.CallOpts, roleId)
}

// GetRuleData is a free data retrieval call binding the contract method 0x069a3ee9.
//
// Solidity: function getRuleData(uint256 roleId) view returns(((uint8,uint8)[],(uint8,uint256,address,uint256)[],(uint8,uint8,uint8)[]) data)
func (_RuleEntitlementV2 *RuleEntitlementV2CallerSession) GetRuleData(roleId *big.Int) (IRuleEntitlementRuleData, error) {
	return _RuleEntitlementV2.Contract.GetRuleData(&_RuleEntitlementV2.CallOpts, roleId)
}
...
func (_RuleEntitlementV2 *RuleEntitlementV2Caller) GetRuleDataV2(opts *bind.CallOpts, roleId *big.Int) (IRuleEntitlementV2RuleData, error) {
	var out []interface{}
...
//
// Solidity: function getRuleDataV2(uint256 roleId) view returns(((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[]) data)
func (_RuleEntitlementV2 *RuleEntitlementV2Session) GetRuleDataV2(roleId *big.Int) (IRuleEntitlementV2RuleData, error) {
...
//
// Solidity: function getRuleDataV2(uint256 roleId) view returns(((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[]) data)
func (_RuleEntitlementV2 *RuleEntitlementV2CallerSession) GetRuleDataV2(roleId *big.Int) (IRuleEntitlementV2RuleData, error) {
	return _RuleEntitlementV2.Contract.GetRuleDataV2(&_RuleEntitlementV2.CallOpts, roleId)
}
