...
type IArchitectBaseMembershipRequirements struct {
	...
	RuleData	IRuleEntitlementV2RuleData
}
...
// CreateSpace is a paid mutator transaction binding the contract method 0xa74ecaad.
//
// Solidity: function createSpace((string,string,((string,string,uint256,uint256,uint64,address,address,uint256,address),(bool,address[],((uint8,uint8)[],(uint8,uint256,address,bytes)[],(uint8,uint8,uint8)[])),string[]),(string),string,string) SpaceInfo) returns(address)
