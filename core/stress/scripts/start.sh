...
CLIENTS_PER_CONTAINER=$((CLIENTS_COUNT / CONTAINER_COUNT))
# calculate number of processes
PROCESSES_PER_CONTAINER=$((CLIENTS_PER_CONTAINER / CLIENTS_PER_PROCESS))
# calculate the start index for this container
PROCESS_START_INDEX=$((CONTAINER_INDEX * PROCESSES_PER_CONTAINER))
# calculate the end index for this container
PROCESS_END_INDEX=$((PROCESS_START_INDEX + PROCESSES_PER_CONTAINER))
