...
export async function chitChat(client, cfg) {
...
function makeSillyMessage() {
    ...
    const wo = () => w0[Math.floor(Math.random() * w0.length)] + w1[Math.floor(Math.random() * w1.length)];
...
//# sourceMappingURL=chitChat.js.map