...
export async function joinChat(client, cfg) {
    ...
    if (client.clientIndex === cfg.localClients.startIndex) {
        ...
        await client.sendMessage(announceChannelId, `c${cfg.containerIndex}p${cfg.processIndex} Starting up! freeMemory: ${getSystemInfo().FreeMemory}`, { threadId: message.hashStr });
    }
    logger.log('emoji it');
    // emoji it
