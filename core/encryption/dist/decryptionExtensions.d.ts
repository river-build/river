...
import { EncryptedData, SessionKeys, UserInboxPayload_GroupEncryptionSessions } from '@river-build/proto';
...
export declare abstract class BaseDecryptionExtensions {
    ...
    abstract sendKeyFulfillment(args: KeyFulfilmentData): Promise<void>;
