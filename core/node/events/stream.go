...
type SyncStream interface {
	...
	// SaveEphemeralMiniblock saves the given miniblock in ephemeral state.
	// Once stream is completed, ephemeral miniblocks become canonical.
...
// SaveEphemeralMiniblock saves the ephemeral miniblock for the stream.
