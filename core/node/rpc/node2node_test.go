...
// TestSaveEphemeralMiniblock tests the saving of ephemeral miniblocks using internode RPC endpoint.
func TestSaveEphemeralMiniblock(t *testing.T) {
	...
	mediaStreamId, err := shared.StreamIdFromString(shared.STREAM_MEDIA_PREFIX + strings.Repeat("0", 62))
