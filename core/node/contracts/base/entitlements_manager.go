...
func (_EntitlementsManager *EntitlementsManagerCaller) GetChannelEntitlementDataByPermission(opts *bind.CallOpts, channelId [32]byte, permission string) ([]IEntitlementsManagerEntitlementData, error) {
	var out []interface{}
	err := _EntitlementsManager.contract.Call(opts, &out, "getChannelEntitlementDataByPermission", channelId, permission)
...
//
// Solidity: function getChannelEntitlementDataByPermission(bytes32 channelId, string permission) view returns((string,bytes)[])
func (_EntitlementsManager *EntitlementsManagerSession) GetChannelEntitlementDataByPermission(channelId [32]byte, permission string) ([]IEntitlementsManagerEntitlementData, error) {
	return _EntitlementsManager.Contract.GetChannelEntitlementDataByPermission(&_EntitlementsManager.CallOpts, channelId, permission)
}

// GetChannelEntitlementDataByPermission is a free data retrieval call binding the contract method 0x40cd83fb.
//
// Solidity: function getChannelEntitlementDataByPermission(bytes32 channelId, string permission) view returns((string,bytes)[])
func (_EntitlementsManager *EntitlementsManagerCallerSession) GetChannelEntitlementDataByPermission(channelId [32]byte, permission string) ([]IEntitlementsManagerEntitlementData, error) {
	return _EntitlementsManager.Contract.GetChannelEntitlementDataByPermission(&_EntitlementsManager.CallOpts, channelId, permission)
}
