 ...
 * @group main
 */
import { isValidStreamId, makeDMStreamId, checkStreamId, makeUniqueChannelStreamId, makeUniqueGDMChannelStreamId, makeUniqueMediaStreamId, makeUserStreamId, userIdFromAddress, addressFromUserId, getUserIdFromStreamId, getUserAddressFromStreamId, } from './id';
import { makeRandomUserContext, makeUniqueSpaceStreamId } from './util.test';
describe('idTest', () => {
    test('validStreamId', () => {
        expect(isValidStreamId('10b6cd7a587ea499f57bfdc820b8c57ef654e38bc4' + '0'.repeat(22))).toBe(true);
        expect(isValidStreamId('101010101010101010101010101010101010101010' + '0'.repeat(22))).toBe(true);
        ...
        expect(isValidStreamId('10B6cd7a587ea499f57bfdc820b8c57ef654e38bc4572e7843df05321dd74c2f')).toBe(false);
        expect(isValidStreamId('1110101010101010101010101010101010101010101010101010101010101010')).toBe(false);
        ...
        expect(isValidStreamId('10b6cd7a587ea499f57bfdc820b8c57ef654e38bc4572e7843df05321dd74c2f36')).toBe(false);
        expect(isValidStreamId('101010101010101010101010101010101010101010101010101010101010101010')).toBe(false);
    ...
    test('makeUserStreamId', () => {
        expect(makeUserStreamId('0x376eC15Fa24A76A18EB980629093cFFd559333Bb')).toBe('a8376ec15fa24a76a18eb980629093cffd559333bb' + '0'.repeat(22));
    });
