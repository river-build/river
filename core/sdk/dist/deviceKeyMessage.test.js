...
describe('deviceKeyMessageTest', () => {
    ...
    test('bobDownloadsAlicesDeviceKeys', async () => {
        ...
        alicesClient.once('userDeviceKeyMessage', (streamId, userId, userDevice) => {
    ...
    test('bobDownloadsAlicesAndOwnDeviceKeys', async () => {
        ...
        bobsClient.on('userDeviceKeyMessage', (streamId, userId, userDevice) => {
...
//# sourceMappingURL=deviceKeyMessage.test.js.map