...
import { getChannelPayload, getMessagePayload, make_ChannelPayload_Inception, make_ChannelPayload_Message, make_MemberPayload_Membership2, make_SpacePayload_Inception, make_UserPayload_Inception, } from './types';
...
const createNewChannelAndPostHello = async (bobsContext, spacedStreamId, bobsUserId, bob) => {
    ...
    const channelCreatePayload = lastEventFiltered(await unpackStreamEnvelopes(spaceResponse.stream), getChannelPayload);
