    ...
    if (process.env.GENERATE_DATA === '1') {
        ...
        for (let shard = 0; shard < SHARDS_LIMIT; ++shard) {
            ...
            test(`checkData_Shard_${s}_of_${SHARDS}`, async () => {
                ...
                log_shard('Started');
                let badHash = bin_fromHexString('8dc27dbd6fc775e3a05c509c6eb1c63c4ab5bc6e7010bf9a9a80a42ae1ea56b0');
                let badSig = bin_fromHexString('8dc27dbd6fc775e3a05c509c6eb1c63c4ab5bc6e7010bf9a9a80a42ae1ea56b08dc27dbd6fc775e3a05c509c6eb1c63c4ab5bc6e7010bf9a9a80a42ae1ea56b000');
